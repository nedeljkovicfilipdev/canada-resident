  ...
  return (
    <div className="bg-dark-blue w-full border-t px-4 py-8 md:px-12">
      <div className="container mx-auto grid grid-cols-1 items-start gap-8 text-black md:grid-cols-3 md:items-center">
        ...
        {/* Middle Section - Russian Client Services */}
        ...
        <div>
          <form className="space-y-4">
            ...
            <Button
              className="w-full bg-red-600 py-2 text-lg font-semibold text-white hover:bg-red-700"
              size="lg"
              type="submit"
            >
              {t('SEND')}
      ...
      <div className="mt-8 text-center text-gray-400">
        ...
        <div>
          <p>&copy; {new Date().getFullYear()} FRBD Consulting Inc. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
