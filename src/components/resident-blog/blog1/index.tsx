    ...
    return (
        <section className="p-2 md:p-4">
            ...
            <img src="images/blog/blogimg3.jpg" alt={t('blog-image3-alt')} className="mb-4 w-full h-auto rounded-xl"/>
                ...
                {/* <img src="images/blog/blogimg2.jpg" alt={t('blog-image2-alt')} className="mb-4 w-full h-auto"/> */}
                ...
                {/* <img src="images/blog/blogimg3.jpg" alt={t('blog-image3-alt')} className="mb-4 w-full h-auto"/> */}
